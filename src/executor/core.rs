...
use crate::{
    agent::Agent,
    info::{gen2::InfoContent, Info, InfoLabel},
    opinion::{
...
// let mut instance = self.new_instance(rng);
// let mut t = 0;
// let mut rps = Vec::new();
// while instance.is_continued() {
//     let ips = I::info_producers(&self, t);
//     let next_rps = self.step(ips, rps, instance.core());
//     let core = instance.core();
//     // core.update_selfish(self, num_iter, t);
//     let mut pop_data = PopData::default();
//     core.selfishes.retain(|&agent_idx| {
//         // let agent = &mut self.agent(agent_idx);
//         let span = span!(Level::INFO, "Ag", "#" = agent_idx);
//         let _guard = span.enter();
//         // if agent.progress_selfish_status() {
//         //     core.agent_stat.push_selfish(num_iter, t, agent_idx);
//         //     pop_data.selfish();
//         //     core.total_num_selfish += 1;
//         // }
//         // agent.is_willing_selfish()
//         true
//     });
//     core.pop_stat.push(num_iter, t, pop_data);
//     core.push_info_stats(num_iter, t);

//     rps = next_rps;
//     t += 1;
// }
// instance.into_core().to_stats()
...
impl<'a, E, V: MyFloat, R, X> InstanceWrapper<'a, E, V, R, X> {
    ...
    // fn update_selfish<E, I>(&'a mut self, executer: &mut E, num_iter: u32, t: u32)
    // where
    //     E: Executor<'a, V, R, I> + ?Sized,
    //     V: MyFloat,
    //     Open01: Distribution<V>,
    //     Standard: Distribution<V>,
    //     StandardNormal: Distribution<V>,
    ...
    // {
    //     let mut pop_data = PopData::default();
    //     self.selfishes.retain(|&agent_idx| {
    //         let agent = &mut executer.agent(agent_idx);
    //         let span = span!(Level::INFO, "Ag", "#" = agent_idx);
    //         let _guard = span.enter();
    //         if agent.progress_selfish_status() {
...
// pub trait AgentInfo<E, V: MyFloat, R, I> {
//     fn get_informer<'a>(
//         exe: &mut E,
//         instance: &mut I,
//         agent_idx: usize,
//         info_idx: usize,
//     ) -> (&'a Info<'a, V>, &'a mut Agent<V>, Trusts<V>, AccessProb<V>);
...
//         agent_idx: usize,
//         info_idx: usize,
//     ) -> (&'a mut Agent<V>, Trusts<V>, AccessProb<V>);
// }
