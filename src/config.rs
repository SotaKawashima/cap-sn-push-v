...
mod tests {
    ...
    fn test_toml_config() {
        let text = r#"
            ...
            [scenario.agent_params.initial_conditions.base.cond_thetad]
            none = { Fixed = [[0.95, 0.00], 0.05] }
            possible = { Fixed = [[0.45, 0.45], 0.10] }
            rates = [[1.0, 1.0], [1.0, 1.0]]
            avoid_u_rates = [1.0, 1.0, 1.0]

            [scenario.agent_params.initial_conditions.base.cond_theta]
            none = { Fixed = [[0.95, 0.00], 0.05] }
            possible = { Fixed = [[0.45, 0.45], 0.10] }
            rates = [[1.0, 1.0], [1.0, 1.0]]

            [scenario.agent_params.initial_conditions.friend.cond_ftheta]
            none = { Fixed = [[0.95, 0.00], 0.05] }
            possible = { Fixed = [[0.45, 0.45], 0.10] }
            rates = [[1.0, 1.0], [1.0, 1.0]]

            [scenario.agent_params.initial_conditions.social.cond_ktheta]
            none = { Fixed = [[0.95, 0.00], 0.05] }
            possible = { Fixed = [[0.45, 0.45], 0.10] }
            rates = [[1.0, 1.0], [1.0, 1.0]]
